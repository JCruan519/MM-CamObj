...
resault_path = '/cluster/home/user1/ywz/workspace/MLLMBenchPipline/camobjbench/eval_claude-3-opus-20240229/resaults/bbox_without_name.json'
question_path = '/cluster/home/user1/ywz/workspace/camouflaged-benchmark/questions/bbox_without_name_questions/data/bbox_position_question.jsonl'
...
def process_question(line):
    ...
    **IMPORTANT**
    ...
    3.Your answer must be in the formart [x1, y1, x2, y2] where x and y are in the range of [0,1]
    ...
    try:
        ...
        model_answer = ask_gpt('claude-3-opus-20240229', "", question, image_data_url)

...
resault_path = '/cluster/home/user1/ywz/workspace/MLLMBenchPipline/camobjbench/eval_claude-3-opus-20240229/resaults/location_choice.json'
question_path = '/cluster/home/user1/ywz/workspace/camouflaged-benchmark/questions/location_choice_quesitons/data/location_choice_questions.jsonl'
...
def process_question(line):
    ...
    model_answer = ask_gpt('claude-3-opus-20240229', "", inputs['question'], local_image_to_data_url(inputs['image']))

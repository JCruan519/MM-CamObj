...
resault_path = '/cluster/home/user1/ywz/workspace/MLLMBenchPipline/camobjbench/eval_claude-3-opus-20240229/resaults/mask_match.json'
...
def process_question(line):
    ...
    model_answer = ask_gpt('claude-3-opus-20240229', "", inputs['question'], [local_image_to_data_url(image_path) for image_path in inputs['image_list']])

...
resault_path = '/cluster/home/user1/ywz/workspace/MLLMBenchPipline/camobjbench/eval_gemini-1.5-pro/resaults/mask_match.json'
...
def process_question(line):
    ...
    model_answer = ask_gpt('gemini-1.5-pro', "", inputs['question'], [local_image_to_data_url(image_path) for image_path in inputs['image_list']])

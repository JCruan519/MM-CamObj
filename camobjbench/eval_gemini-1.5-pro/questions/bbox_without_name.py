...
resault_path = '/cluster/home/user1/ywz/workspace/MLLMBenchPipline/camobjbench/eval_gemini-1.5-pro/resaults/bbox_without_name.json'
...
def process_question(line):
    ...
    **IMPORTANT**
    ...
    try:
        ...
        model_answer = ask_gpt('gemini-1.5-pro', "", question, image_data_url)

from GPT_API import Ask_GPT_35, Ask_GPT4o, ask_gpt_muti_image
...
resault_path = '/cluster/home/user1/ywz/workspace/MLLMBenchPipline/camobjbench/eval_GPT4o/resaults/mask_match.json'
question_path = '/cluster/home/user1/ywz/workspace/camouflaged-benchmark/questions/mask_mach_questions/data/mask_matching_questions.jsonl'
...
def process_question(line):
    ...
    model_answer = ask_gpt_muti_image('gpt-4o', "", inputs['question'], [local_image_to_data_url(image_path) for image_path in inputs['image_list']])

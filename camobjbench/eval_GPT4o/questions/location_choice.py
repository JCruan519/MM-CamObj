...
resault_path = '/cluster/home/user1/ywz/workspace/MLLMBenchPipline/camobjbench/eval_GPT4o/resaults/location_choice.json'
...
def process_question(line):
    ...
    model_answer = ask_gpt('gpt-4o', "", inputs['question'], local_image_to_data_url(inputs['image']))

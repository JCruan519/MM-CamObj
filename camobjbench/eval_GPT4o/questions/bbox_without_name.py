...
resault_path = '/cluster/home/user1/ywz/workspace/MLLMBenchPipline/camobjbench/eval_GPT4o/resaults/bbox_without_name.json'
...
def process_question(line):
    ...
    **IMPORTANT**
    ...
    try:
        ...
        model_answer = ask_gpt('gpt-4o', "", question, image_data_url)
